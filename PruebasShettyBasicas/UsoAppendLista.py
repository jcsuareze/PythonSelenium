...
for result in products:
    #usamos el metodo append para añadir los productos a la lista vacia actualList
    actualList.append(result.find_element(By.XPATH, "h4").text)
    result.click()

#Aqui comparamos las listas de productos esperados con los productos que se han añadido al carrito
